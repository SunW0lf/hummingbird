...
- [`XFMR_PROTOCOL_PALACE.md`](./XFMR_PROTOCOL_PALACE.md) — the current XFMR cast, role/state vocabulary, DNS-as-protocol sketch, and the first machine-readable discovery room.
