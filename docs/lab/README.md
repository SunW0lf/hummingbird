...
- [`../../experimental/xfmr/README.md`](../../experimental/xfmr/README.md) — the minimal XFMR Worker serving `xfmr.link`; pull requests validate it and reviewed changes merged to `main` deploy automatically through the dedicated XFMR workflow.
